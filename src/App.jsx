...
const App = () => {
  ...
  const predictMood = () => {
    if (moodData.length < 3)
      return { emoji: "❓", message: "Not enough data to predict your mood." };
      ...
      return {
        ...
        message: (
          <span>
            ...
            <span className="font-bold">{moodText}</span> again tomorrow unless
    ...
    return {
      emoji: "❓",
      message:
        "The moods for the last 3 days are mixed. Hence no prediction available.",
    };
  };
      ...
      <div className="min-h-screen">
        <div className="container mx-auto p-4">
          ...
          <div
            ...
            } p-4 rounded shadow text-center mt-4`}
          >
